...
assert("Works with the simple example", total_calibration_result("3267: 81 40 27"), 3267)
assert("Works with the simple example", total_calibration_result("7290: 6 8 6 15"), 0)
assert("Works with the simple example", total_calibration_result("292: 11 6 16 20"), 292)
...
assert("Works with the example from the page", total_calibration_result(sample_from_page), 3749)

assert("Works with the real deal!", total_calibration_result(File.read('./input07.txt')), 66343330034722)
