...
describe "Huffman" do
  context 'encode' do
    it 'generate an output file with a header that includes the prefix table' do
      ...
      FileUtils.rm_f("#{root_dir}/fixtures/output")
      output_file = "#{root_dir}/fixtures/output"
      Huffman.new.encode("#{root_dir}/fixtures/lesmiserables.txt", output_file)
    ...
    it 'stores the padding length' do
      ...
      FileUtils.rm_f("#{root_dir}/fixtures/output")
      output_file = "#{root_dir}/fixtures/output"
      Huffman.new.encode("#{root_dir}/fixtures/sample.txt", output_file)
  ...
  context 'decode' do
    it 'decodes the encoded file' do
      ...
      FileUtils.rm_f("#{root_dir}/fixtures/output")
      output_file = "#{root_dir}/fixtures/output"
      Huffman.new.encode("#{root_dir}/fixtures/test_short.txt", output_file)
